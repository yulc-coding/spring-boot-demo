package org.ylc.frame.springbootdemo.boot;
...
import org.ylc.frame.springbootdemo.util.CacheUtil;
import org.ylc.frame.springbootdemo.util.DateUtils;
...
public class RedisStartupBoot implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            ...
            map.put("startup-time", DateUtils.getCurDateTime());
